<div class="pagination">
	...
	<ul class="per-page">
		...
		<li class="<?php if ($i == count($per_page_choices)-1): ?>next<?php endif; ?> <?php if ($per_page==$choice): ?>active<?php endif; ?>"><a href="<?php echo URL::site(Route::get($route)->uri(array_merge($route_params, array($route_page_param => 1, 'per_page' => $choice)))); ?>"><?php echo $choice; ?></a></li>
		<?php endforeach; ?>
	</ul>
